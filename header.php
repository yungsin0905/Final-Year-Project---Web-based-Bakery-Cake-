        ...
        <div class="mega-menu">
            ...
            <div class="menu-column">
                ...
                <ul>
                    ...
                    <li><a href="product catalogue.php?id=6">Birthday Cakes</a></li>
                </ul>
            </div>
            <div class="menu-column">
                <h4>Cake Type</h4>
                <ul>
                    ...
                    <li><a href="product catalogue.php?id=1">Cheese Cakes</a></li>
                    <li><a href="product catalogue.php?id=2">Fruit Cakes</a></li>
                    <li><a href="product catalogue.php?id=3">Gluten-Free Cakes</a></li>
                    <li><a href="product catalogue.php?id=4">Vegan Cakes</a></li>
                </ul>
            </div>
        </div>
      </div>
