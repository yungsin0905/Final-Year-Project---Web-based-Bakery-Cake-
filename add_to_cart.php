...
if (isset($_POST['product_id']) && !empty($_POST['product_id'])) {
    ...
    $insert_item_sql = "INSERT INTO cart_item (CART_ID, VARIANT_ID, PRODUCT_ID, QUANTITY, CAKE_WRITING, CARD_TEXT) 
                        VALUES ($cart_id, $variant_id, $product_id, $qty, $cake_val, $card_val)";
    ...
    if (mysqli_query($conn, $insert_item_sql)) {
        ...
        foreach ($selected_addons as $addon_id) {
            ...
            $addon_sql = "INSERT INTO cart_item_addon (CART_ITEM_ID, ADD_ON_ID, QUANTITY) VALUES ($cart_item_id, $addon_id, $aqty)";
